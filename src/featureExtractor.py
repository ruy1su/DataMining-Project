...
MOOD_PN_PATH = [utils.GOOG_MOOD_PN, utils.AAPL_MOOD_PN, utils.MSFT_MOOD_PN]

# define path to sentimental analysis result (multi-dimension)
MOOD_MULTI_PATH = [utils.GOOG_MOOD_MULTI, utils.AAPL_MOOD_MULTI, utils.MSFT_MOOD_MULTI]
